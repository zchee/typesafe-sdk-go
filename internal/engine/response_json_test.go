...
func TestAnswerJSONShapes(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"success: zero NoulAnswer, not present, is null":          {NoulAnswer{}, `null`},
		"success: zero ChoiceAnswer, not present, is null":        {ChoiceAnswer{}, `null`},
		"success: zero ScoreAnswer, not present, is null":         {ScoreAnswer{}, `null`},
